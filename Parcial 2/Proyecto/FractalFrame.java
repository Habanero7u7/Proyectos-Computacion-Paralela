...
public class FractalFrame extends JFrame {
    ...
    public FractalFrame() {
        setTitle("Fractal Generator - Julia Set");
        setSize(1500, 1000);
    ...
    private void startFractalGeneration(JButton startButton, JButton stopButton, JButton continueButton) {
        ...
        fractalThread = new Thread(() -> {
            ...
            if (isRunning) {
                ...
                tableModel.addRow(new Object[]{currentProcessor.getClass().getSimpleName(), endTime - startTime});
            }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new FractalFrame().setVisible(true));
    }
}
